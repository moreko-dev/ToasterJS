import t from"./ToastConsts.min.js";class ToasterJS{#a=[];#b;#c;#d;#e;#f;#g;#h;#i;constructor(e={}){this.#b=e.animation||t.Animation.FADE,this.#c=e.direction||t.Direction.AUTO,this.#d=e.position||t.Position.BOTTOM_LEFT,this.#e=e.duration||2e3,this.#f=e.roundedValue||"0",this.#g=e.limit||5,this.#h=e.queue||!1,this.#j()}#j(){if(this.#i=document.querySelector(".toasterjs-toasts-container"),!this.#i){let e=document.createElement("div");e.className="toasterjs-toasts-container",this.#i=e,document.body.insertAdjacentElement("beforeend",e)}let i=t.getStyleByPosition(this.#d);this.#i.style.justifyContent=i.jc,this.#i.style.alignItems=i.ai,this.#i.style.direction=this.#c,this.#i.style.height=`${window.innerHeight-16}px`,document.addEventListener("click",t=>{let e=t.target.closest(".toasterjs-toast > .close > .close-button");e&&e.parentElement.parentElement.remove()}),window.addEventListener("resize",()=>{this.#i.style.height=`${window.innerHeight-16}px`})}toast(e,i={},s=null){if(!this.#i)return;let n=i.type||t.Type.DEFAULT,a=i.duration||this.#e,o=i.animation||this.#b,l=i.roundedValue||this.#f,r=this.#k(e,n,s);r.classList.add(o,"hide"),r.style.borderRadius=l,this.#l(r,this.#m.bind(this),r,{duration:a})}toastPending(e,i,s=null,n={}){if(!this.#i)return;let a=n.animation||this.#b,o=n.roundedValue||this.#f,l=this.#k(e,t.Type.PENDING,s);l.classList.add(a,"hide"),l.style.borderRadius=o,this.#l(l,this.#n.bind(this),l,{action:i.action,onSuccess:i.onSuccess,onError:i.onError})}toastAction(e,i,s=null,n={}){if(!this.#i)return;let a=n.type||t.Type.QUESTION,o=n.animation||this.#b,l=n.roundedValue||this.#f,r=this.#o(e,a,i,s);r.classList.add(o,"hide"),r.style.borderRadius=l,this.#l(r,this.#p.bind(this),r)}#m(s,n={}){let a=n.duration||this.#e;this.#p(s),setTimeout(()=>{this.#q(s),this.#r()},a)}#n(o,l={}){return this.#p(o),new Promise(async(t,e)=>{try{let i=await l.action();this.#q(o),l.onSuccess(),t(i)}catch(s){this.#q(o),l.onError(),e(s)}this.#r()})}#k(r,d,c=null){let h=document.createElement("div");return h.classList.add("toasterjs-toast",d),h.innerHTML=`
            <div class="icon">${t.Icon[d.toUpperCase()]}</div>
            <div class="content">
                <span class="toasterjs-toast__title">${c??""}</span>
                <span class="toasterjs-toast__message">${r}</span>
            </div>
            <div class="close">
